...
ICON   = f"{ROOT}/assets/latte_bgm/images/brand/latte_dog_icon_circle.png"
...
OUTPUT = f"{ROOT}/assets/latte_bgm/videos/final/cafe_warm_30min_004.mp4"
...
print("=" * 58)
print("  Latte BGM — Cafe Warm 30min 動画生成 (004 / 003改善版)")
print("=" * 58)
print(f"  画像  : {IMAGE}")
print(f"  音源  : {AUDIO}")
print(f"  アイコン: {ICON}")
